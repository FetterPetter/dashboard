...
import {Saleschart} from "../components/Salechart.js";
        ...
        <div className="dashboard">
                    ...
                    <div className="card">
                        ...
                        <div className="produkter">
                            <div>
                                ...
                                <img src="/dashboard/images/jakke.PNG" alt="jakke"/></div>

                            <div>
                                <div className="tall">2</div>
                                <img src="/dashboard/images/genser.PNG" alt="genser"/></div>

                            <div>
                                <div className="tall">3</div>
                                <img src="/dashboard/images/sko.PNG" alt="sko"/></div>
            ...
            <div className="bottom-row">
                <div className="card">
                  ...
                  <Paigraf salg={statsData[activeTab].salg}
